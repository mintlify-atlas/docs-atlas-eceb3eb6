...
description: "Remix adapter for building Shopify apps with the Shopify App JavaScript SDK"
---
...
Creates an object your app will use to interact with Shopify in a Remix application.
...
<ParamField path="appConfig" type="AppConfigArg" required>
  ...
  <Expandable title="properties">
    ...
    <ParamField path="authPathPrefix" type="string" default="/auth">
      A path that Shopify can reserve for auth-related endpoints. Must match a $ route in your Remix app.
    </ParamField>
    ...
    <ParamField path="billing" type="BillingConfig">
      Billing configuration for your app
    </ParamField>
...
const shopify = shopifyApp({
  ...
  hooks: {
    afterAuth: async ({ session, admin }) => {
      // Seed data or register webhooks
